...
1. Install dependencies. This also installs your local copy of the nativescript-angular plugin.

   ``` Shell
   npm install
   ```

1. Make sure to have an emulator set up or connect a physical Android/iOS device.
...
1. Install [appium](http://appium.io/) globally.

   ``` Shell
   npm install -g appium
   ```

1. Follow the instructions in the [nativescript-dev-appium](https://github.com/nativescript/nativescript-dev-appium#custom-appium-capabilities) plugin to add an appium capability for your device inside `./e2e/renderer/e2e/config/appium.capabilities.json`.

1. Run the automated tests. The value of the `runType` argument should match the name of the capability that you just added.
...
1. Build `nativescript-angular` (a.k.a. "compat-package"):
